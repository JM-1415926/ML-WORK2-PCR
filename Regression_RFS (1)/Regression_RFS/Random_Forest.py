...
def train_and_save_rf(X, y, output_model_path="rf_model.pkl"):
    """
    Args:
        X (pd.DataFrame): Feature matrix.
        y (pd.Series): Target variable.
    ...
    # Define Random Forest model and parameter range
    ...
    grid_search = GridSearchCV(
        rf, param_grid, scoring='neg_mean_absolute_error', cv=cv_strategy, verbose=2, n_jobs=-1, error_score='raise'
    )
...
if __name__ == "__main__":
    ...
    best_model = train_and_save_rf(X, y, model_path)
